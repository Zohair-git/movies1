...
<body>
 ...
 <div class="banner-bg bg_img bg-fixed" databackground="./assets/images/banner/banner01.jpg"></div>
 <div class="container">
 ...
 <a href="#0">
 <img src="./images/marvel.jpg" alt="banner" height="180px">
 </a>
 </div>
 </div>
 ...
 <div class="widget-1-body">
 <a href="#0">
 <img src="./images/dc.jpg" alt="banner" height="180px">
 </a>
 </div>
 </div>
 </div>
 ...
 $date_now = date('y-m-d');
 if(strtotime($date_now) < strtotime($row['Movie Date']) ){?>
